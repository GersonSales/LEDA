...
public class BritoTest3 {
    ...
    public void testCustom() {
        ...
        verifyHeap(new Integer[] { Integer.MIN_VALUE, -1, -2, 0, 0, 100, 20, 10,
                1, 0, 12, Integer.MAX_VALUE, 109, 101 });

        Integer[] array = new Integer[] { Integer.MAX_VALUE, 12, 109, 0, 1, 100,
                101, -1, 0, -2, 0, 10, 20, Integer.MIN_VALUE };
        Arrays.sort(array);

        assertArrayEquals(array,
                heap.heapsort(new Integer[] { Integer.MAX_VALUE, 12, 109, 0, 1,
                        100, 101, -1, 0, -2, 0, 10, 20, Integer.MIN_VALUE }));
        assertTrue(heap.isEmpty());
        verifyHeap(new Integer[] {});

        assertArrayEquals(new Integer[] { 1, 2, 3, 4 },
                heap.heapsort(new Integer[] { 4, 2, 3, 1 }));
        assertTrue(heap.isEmpty());
        verifyHeap(new Integer[] {});
        ...
        assertFalse(heap.isEmpty());
        assertEquals(14, heap.size());
        verifyHeap(new Integer[] { Integer.MAX_VALUE, 12, 109, 0, 1, 100, 101,
                -1, 0, -2, 0, 10, 20, Integer.MIN_VALUE });
    }
    ...
    public void testShortestPath() {
        ...
        int[][] graph = new int[][] { { 0, 5, 28, 0, 0, 3, 0 },
                { 0, 0, 0, 7, 11, 0, 0 }, { 15, 0, 0, 0, 0, 0, 19 },
                { 0, 0, 0, 0, 0, 0, 30 }, { 9, 0, 0, 0, 0, 2, 0 },
                { 0, 0, 0, 0, 0, 0, 91 }, { 0, 0, 0, 0, 0, 7, 0 } };
    ...
    public void testKruskal() {
        ...
        int[][] graph = new int[][] { { 0, 7, 0, 5, 0, 0, 0 },
                { 7, 0, 8, 9, 7, 0, 0 }, { 0, 8, 0, 0, 5, 0, 0 },
                { 5, 9, 0, 0, 15, 6, 0 }, { 0, 7, 5, 15, 0, 8, 9 },
    ...
    static class PairTwo implements Comparable<PairTwo> {
        ...
        public boolean equals(Object other) {
            if (other instanceof PairTwo) {
                return ((PairTwo) other).to == this.to
                        && ((PairTwo) other).from == this.from;
            }
            return false;
        }
