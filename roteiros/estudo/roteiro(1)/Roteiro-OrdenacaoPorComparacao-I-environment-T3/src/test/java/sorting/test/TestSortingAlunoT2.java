...
public class TestSortingAlunoT2 {
    ...
    protected final Integer[] ascendingArray = { -1, -1, 3, 4, 5, 6, 7, 8, 9,
            10 };
    protected final Integer[] descendingArray = { 10, 9, 8, 7, 6, 5, 4, 3, -1,
            -1 };
    protected final Integer[] shuffledArray = { 10, -1, -1, 3, 9, 5, 8, 4, 7,
            6 };
    ...
    protected final Object[] expectedArray = { -1, -1, 3, 4, 5, 6, 7, 8, 9,
            10 };
