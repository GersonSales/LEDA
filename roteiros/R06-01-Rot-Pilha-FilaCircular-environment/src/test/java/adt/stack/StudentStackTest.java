...
public class StudentStackTest {
	...
	public void testPopComErro() throws StackUnderflowException {
		...
		assertEquals(new Integer(2), stack1.pop()); //levanta excecao apenas se stack1 for vazia
		assertEquals(new Integer(1), stack1.pop()); //levanta excecao apenas se stack1 for vazia
		assertEquals(new Integer(0), stack1.pop()); //levanta excecao apenas se stack1 for vazia
