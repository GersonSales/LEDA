 ...
 * the sub-arrays.
 */
public class IntercaledBubblesort2<T extends Comparable<T>> extends SortingImpl<T>{
	protected void sort(T[] array,int leftIndex, int rightIndex){
		...
		Mergesort(leftIndex, ((rightIndex+leftIndex)/2), array);
		Mergesort((((rightIndex+leftIndex)/2) + 1), rightIndex, array);
	}
