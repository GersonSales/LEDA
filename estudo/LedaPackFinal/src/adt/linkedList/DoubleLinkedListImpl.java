...
public class DoubleLinkedListImpl<T> extends SingleLinkedListImpl<T> implements
	...
	public void insertFirst(T element) {
		if (element != null) {
			...
			if (head.isNIL()) {
				...
				newNode = new DoubleLinkedListNode<T>(element, last, (DoubleLinkedListNode<T>) head);
				head.next = newNode;
				last.previous = newNode;
				last = newNode;
			} 
			else {
				newNode = new DoubleLinkedListNode<T>(element, (DoubleLinkedListNode<T>) head, ((DoubleLinkedListNode<T>) head).previous);
	...
	public void insert(T element) {
		if (element != null) {
			if (head.isNIL()) {
				...
				DoubleLinkedListNode<T> newLast = new DoubleLinkedListNode<T>(element, (DoubleLinkedListNode<T>) last.next, last);
	...
	public DoubleLinkedListNode<T> locate(T element) {
	...
	public T search(T element) {
		DoubleLinkedListNode<T> aux = locate(element);
