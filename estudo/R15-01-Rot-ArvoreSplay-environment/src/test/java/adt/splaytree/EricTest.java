...
//        synchronized (this) {
//            for (Integer e : new Integer[] { 10, 29, 1, 32, 89, 75, 44, 20, 33,
//                    -29, 12, 69, 42 })
//                splay.insert(e);
...
//    }
    ...
    public void meusTests() {
        ...
        assertEquals(3, splay.height());
        assertArrayEquals(new Integer[] { 3, 0, 1, 5, 13, 22 },
                splay.preOrder());
        ...
        assertArrayEquals(new Integer[] { 100, 22, 18, 5, 3, 0, 1, 13 },
                splay.preOrder());
        ...
        assertEquals(8, splay.size());
        assertEquals(3, splay.height());
        assertArrayEquals(new Integer[] { 5, 3, 0, 1, 100, 18, 13, 22 },
                splay.preOrder());
        ...
        assertArrayEquals(new Integer[] { 13, 5, 3, 0, 1, 18, 100, 22 },
                splay.preOrder());
        ...
        assertArrayEquals(new Integer[] { 3, 0, 1, 5, 13, 18, 100, 22 },
                splay.preOrder());
    }
    ...
    public void meusTestRemove() {
        ...
        assertEquals(3, splay.height());
        assertArrayEquals(new Integer[] { 10, 9, 1, 5, 35, 13, 22 },
                splay.preOrder());
        ...
        assertEquals(7, splay.size());
        assertEquals(4, splay.height());
        assertArrayEquals(new Integer[] { 13, 10, 9, 1, 5, 35, 22 },
                splay.preOrder());
        ...
        assertEquals(6, splay.size());
        assertEquals(3, splay.height());
        assertArrayEquals(new Integer[] { 1, 13, 9, 10, 35, 22 },
                splay.preOrder());
        ...
        assertEquals(2, splay.height());
        assertArrayEquals(new Integer[] { 13, 9, 10, 35, 22 },
                splay.preOrder());
