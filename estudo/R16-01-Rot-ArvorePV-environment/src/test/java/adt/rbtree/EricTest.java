...
public class EricTest {
    ...
    public void testDiniz1() {
        ...
        myRB.insert(5);
        assertTrue(
                ((RBNode<Integer>) myRB.getRoot()).getColour() == Colour.BLACK);

        assertTrue(((RBNode<Integer>) myRB.getRoot().getLeft())
                .getColour() == Colour.BLACK);

        assertTrue(((RBNode<Integer>) myRB.getRoot().getRight())
                .getColour() == Colour.BLACK);
        ...
        assertTrue(((RBNode<Integer>) myRB.getRoot().getRight().getRight())
                .getColour() == Colour.BLACK);
        assertTrue(((RBNode<Integer>) myRB.getRoot().getRight().getLeft())
                .getColour() == Colour.BLACK);

        // FOLHAS NIL DEVEM SER BLACK
        assertTrue(((RBNode<Integer>) myRB.getRoot().getLeft().getRight())
                .getColour() == Colour.BLACK);
        assertTrue(((RBNode<Integer>) myRB.getRoot().getLeft().getLeft())
                .getColour() == Colour.BLACK);
        ...
        assertEquals(new Integer(6),
                myRB.getRoot().getLeft().getRight().getData());
        ...
        assertEquals(new Integer(5),
                myRB.getRoot().getLeft().getLeft().getData());
        ...
        assertTrue(((RBNode<Integer>) myRB.getRoot().getLeft().getRight()
                .getLeft()).getColour() == Colour.BLACK);
        assertTrue(((RBNode<Integer>) myRB.getRoot().getLeft().getRight()
                .getRight()).getColour() == Colour.BLACK);
        assertTrue(
                ((RBNode<Integer>) myRB.getRoot().getLeft().getLeft().getLeft())
                        .getColour() == Colour.BLACK);
        assertTrue(((RBNode<Integer>) myRB.getRoot().getLeft().getLeft()
                .getRight()).getColour() == Colour.BLACK);
        assertTrue(((RBNode<Integer>) myRB.getRoot().getRight().getLeft())
    ...
    public void naoOqueVoceEsperavaPontoPy() {
        ...
        assertTrue(myRB.verifyProperties());
        Assert.assertArrayEquals(myRB.rbPreOrder(),
                awyiss((RBNode<Integer>) myRB.getRoot()));
